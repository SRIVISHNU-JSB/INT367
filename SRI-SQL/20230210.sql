...
CREATE TABLE CRICKET11(UID NUMBER,NAME CHAR(22));
...
--CONSTRAINT MYCONTRAINT2 CHECK(AGE>21)
);

CREATE TABLE POPULATION5
(
NAME CHAR(20),
AGE NUMBER,
UIDS NUMBER
...
CREATE TABLE CRICKET1 (UID NUMBER NOT NULL UNIQUE, NAME VARCHAR2(44));

//UID IS A RESERVED KEYWORD TO GET THE UNIQUE ID OF USER SESSION
